                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <form id="form-reg">
                            ...
                            <div class="form-group row">
                                <label for="staticEmail" class="col-3 col-form-label">Password</label>
                                <div class="col-9">
                                    <input type="password" name="password" class="form-control" placeholder="Set your login password">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <label for="staticEmail" class="col-3 col-form-label">Verification Code</label>
                                <div class="col-9">
                                    <input type="text" name="code" class="form-control" placeholder="Enter the verification code">
                                    <img title="Click to refresh" src="/captcha"
                            ...
                            <div class="form-group row">
                                <div class="col-12">
                                    <div class="alert alert-info">
                                        You are registering with an invitation link. After verifying your email, both you and the inviter will receive bonus points!
                                    </div>
                                </div>
                            </div>
                            @endif
                            <div class="form-group text-center">
                                <a class="btn btn-info text-white" @click="reg"> Register </a>
                            </div>
                            <div class="form-group text-center">
