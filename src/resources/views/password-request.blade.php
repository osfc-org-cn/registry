    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-md-6 offset-md-3 mt-3 mt-sm-5">
                <div class="card mb-3">
                    <div class="card-header text-white bg-info">Forgot Password</div>
                    <div class="card-body">
                        <form id="form-password">
                            <input type="hidden" name="action" value="sendPasswordEmail">
                            <div class="form-group row">
                                <label for="staticEmail" class="col-3 col-form-label">Account</label>
                                <div class="col-9">
                                    <input type="text" name="username" class="form-control" placeholder="Enter the account or email you want to find">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group text-center">
                                <a class="btn btn-info text-white" @click="password"> Send Reset Link </a>
                            </div>
                            <div class="form-group text-center">
