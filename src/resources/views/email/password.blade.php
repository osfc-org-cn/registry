    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%" style="max-width: 600px; margin: 0 auto; font-family: 'Arial', sans-serif; color: #111827; background-color: #ffffff; border-radius: 8px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); border: 1px solid #e5e7eb;">
        <tr>
            <td style="padding: 30px 20px; text-align: center; background: linear-gradient(135deg, #2563eb, #7c3aed); border-radius: 8px 8px 0 0;">
                <h1 style="color: #ffffff; font-size: 24px; margin: 0; font-weight: 600;">Password Reset</h1>
            </td>
        </tr>
        <tr>
            <td style="padding: 30px 20px; text-align: left;">
                ...
                <p style="font-size: 16px; line-height: 1.6; color: #4b5563; margin-bottom: 20px;">You've requested to reset your password for your {{ $webName }} account. Please click the button below to create a new password.</p>
                
                <div style="text-align: center; margin: 30px 0;">
                    <a href="{{ $url }}" style="display: inline-block; padding: 12px 24px; background: linear-gradient(135deg, #2563eb, #7c3aed); color: #ffffff; text-decoration: none; font-weight: 600; border-radius: 9999px; font-size: 16px;">Reset Password</a>
                </div>
                
                <p style="font-size: 16px; line-height: 1.6; color: #4b5563; margin-bottom: 20px;">If you didn't request this password reset, you can safely ignore this email.</p>
