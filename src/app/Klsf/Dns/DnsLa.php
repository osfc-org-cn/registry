...
class DnsLa implements DnsInterface
{
    ...
    function updateDomainRecord($RecordId, $Name, $Type, $Value, $LineId, $DomainId = null, $Domain = null, $Options = null)
    {
        $params = [];
        $params['cmd'] = 'edit';
        $params['domainid'] = $DomainId;
        ...
        if ($Type === 'MX' && $Options && isset($Options['mx'])) {
            $params['mxpriority'] = intval($Options['mx']);
        }
    ...
    function addDomainRecord($Name, $Type, $Value, $LineId, $DomainId = null, $Domain = null, $Options = null)
    {
        $params = [];
        $params['cmd'] = 'create';
        $params['domainid'] = $DomainId;
